...
class Rule(Base):
    ...
    images_path_xpath = Column(String)
    download_xpath = Column(String)
    main_image_xpath = Column(String)
    multiple_image_xpath = Column(String)
